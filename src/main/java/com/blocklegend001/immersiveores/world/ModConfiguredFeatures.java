...
public class ModConfiguredFeatures {
    ...
    public static void boostrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, OVERWORLD_VIBRANIUM_ORE_KEY, Feature.ORE, new OreConfiguration(overworldVibraniumOres, ImmersiveOresConfig.OrePerVeinVibranium.get()));
        register(context, NETHER_VULPUS_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.VULPUS_ORE.get().defaultBlockState(), ImmersiveOresConfig.OrePerVeinVulpus.get()));
        register(context, END_ENDERIUM_ORE_KEY, Feature.ORE, new OreConfiguration(endReplaceables,
                ModBlocks.ENDERIUM_ORE.get().defaultBlockState(), ImmersiveOresConfig.OrePerVeinEnderium.get()));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(ImmersiveOres.MODID, name));
    }
