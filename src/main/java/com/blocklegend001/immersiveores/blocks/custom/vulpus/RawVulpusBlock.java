...
public class RawVulpusBlock extends Block implements ColoredBlock {
    ...
    @Override
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pContext, List<Component> components, TooltipFlag pTooltipFlag) {
    ...
    public boolean canHarvestBlock(BlockState state, BlockGetter level, BlockPos pos, Player player) {
        ...
        if (state.getBlock() == ModBlocks.RAW_VULPUS_BLOCK.get()) {
