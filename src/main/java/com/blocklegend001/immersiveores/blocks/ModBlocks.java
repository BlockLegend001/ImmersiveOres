...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> VIBRANIUM_BLOCK = registerBlock("vibranium_block",
            () -> new VibraniumBlock(BlockBehaviour.Properties.copy(Blocks.NETHERITE_BLOCK)
    ...
    public static final RegistryObject<Block> VULPUS_BLOCK = registerBlock("vulpus_block",
            () -> new VulpusBlock(BlockBehaviour.Properties.copy(ModBlocks.VIBRANIUM_BLOCK.get())
                    .strength(6.5f, 1200.0F).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> ENDERIUM_BLOCK = registerBlock("enderium_block",
            () -> new EnderiumBlock(BlockBehaviour.Properties.copy(ModBlocks.VULPUS_BLOCK.get())
                    .strength(6.5f, 1200.0F).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> RAW_VIBRANIUM_BLOCK = registerBlock("raw_vibranium_block",
            () -> new RawVibraniumBlock(BlockBehaviour.Properties.copy(Blocks.NETHERITE_BLOCK)
                    .strength(6.5f, 1200.0F).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> RAW_VULPUS_BLOCK = registerBlock("raw_vulpus_block",
            () -> new RawVulpusBlock(BlockBehaviour.Properties.copy(ModBlocks.RAW_VIBRANIUM_BLOCK.get())
                    .strength(6.5f, 1200.0F).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> RAW_ENDERIUM_BLOCK = registerBlock("raw_enderium_block",
            () -> new RawEnderiumBlock(BlockBehaviour.Properties.copy(ModBlocks.RAW_VULPUS_BLOCK.get())
                    .strength(6.5f, 1200.0F).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> VIBRANIUM_ORE = registerBlock("vibranium_ore",
            () -> new VibraniumOre(BlockBehaviour.Properties.copy(Blocks.ANCIENT_DEBRIS)
    ...
    public static final RegistryObject<Block> VULPUS_ORE = registerBlock("vulpus_ore",
            () -> new VulpusOre(BlockBehaviour.Properties.copy(ModBlocks.VIBRANIUM_ORE.get())
                    .strength(6f, 1200.0F).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> ENDERIUM_ORE = registerBlock("enderium_ore",
            () -> new EnderiumOre(BlockBehaviour.Properties.copy(ModBlocks.VULPUS_ORE.get())
                    .strength(6f, 1200.0F).requiresCorrectToolForDrops()));
