...
public class Excavator extends MiningToolItem {
    public Excavator(ToolMaterial material, int p_42962_, float p_42963_, Settings settings) {
        super(material, BlockTags.SHOVEL_MINEABLE, p_42962_, p_42963_, settings);
    }
