...
public class VulpusPaxel extends Paxel {
    ...
    public VulpusPaxel(Tier tier, int attackDamage, float attackSpeed, Properties properties) {
        super(tier, ModTags.Blocks.VULPUS_PAXEL_MINEABLE, attackDamage, attackSpeed, createSettings());
    }
