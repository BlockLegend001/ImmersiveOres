...
public class VibraniumExcavator extends Excavator implements Vanishable {

    public VibraniumExcavator(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
