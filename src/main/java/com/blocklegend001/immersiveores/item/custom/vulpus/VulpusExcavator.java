...
public class VulpusExcavator extends Excavator implements Vanishable {

    public VulpusExcavator(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
