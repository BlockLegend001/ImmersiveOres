...
public class VulpusHammer extends Hammer {
    private static Settings createSettings(boolean unbreakable, int durability) {
        Settings settings = new Settings()
                ...
                .fireproof()
                .attributeModifiers(VulpusHammer.createAttributeModifiers(ModToolMaterials.VULPUS,
                        VulpusConfig.attackDamageVulpusHammer, (float) VulpusConfig.attackSpeedVulpusHammer));
