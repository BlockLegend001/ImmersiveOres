...
public class VibraniumAxe extends AxeItem {
    private static Properties createSettings(boolean unbreakable, int durability) {
        Properties settings = new Properties()
                ...
                .attributes(VibraniumAxe.createAttributes(
                        ModToolTiers.VIBRANIUM,
                        VibraniumConfig.ATTACK_DAMAGE_VIBRANIUM_AXE.get(),
                        (float) VibraniumConfig.ATTACK_SPEED_VIBRANIUM_AXE.get().doubleValue()
                ));
    ...
    public VibraniumAxe(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
