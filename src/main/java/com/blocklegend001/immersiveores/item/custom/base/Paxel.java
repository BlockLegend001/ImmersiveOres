...
public class Paxel extends MiningToolItem {
    ...
    public Paxel(ToolMaterial pTier, int attackDamage, float attackSpeed, TagKey<Block> mineableTag, Settings pProperties) {
        super(attackDamage, attackSpeed, pTier, mineableTag, pProperties);
    }
    ...
    private static final class Axe extends AxeItem {
        ...
        private Axe(ToolMaterial pTier, int attackDamage, float attackSpeed, Settings pProperties) {
            super(pTier, attackDamage, attackSpeed, pProperties);
        }
    }
    ...
    private static final class Shovel extends ShovelItem {
        ...
        private Shovel(ToolMaterial pTier, int attackDamage, float attackSpeed, Settings pProperties) {
            super(pTier, attackDamage, attackSpeed, pProperties);
        }
    }
}