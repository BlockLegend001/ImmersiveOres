...
public class Paxel extends MiningToolItem {
    ...
    public Paxel(ToolMaterial pTier, TagKey<Block> mineableTag, int pAttackDamageModifier, float pAttackSpeedModifier, Settings pProperties) {
        super(pTier, mineableTag, pAttackDamageModifier, pAttackSpeedModifier, pProperties);
    }
