...
public class Paxel extends DiggerItem {
    ...
    public Paxel(Tier tier,TagKey<Block> mineableTag, float attackDamage, float attackSpeed, Properties properties) {
        super(attackDamage, attackSpeed, tier, mineableTag, properties);
    }
    ...
    private static final class Axe extends AxeItem {
        ...
        private Axe(Tier pTier, float attackDamage, float attackSpeed, Properties pProperties) {
    ...
    private static final class Shovel extends ShovelItem {
        ...
        private Shovel(Tier pTier, float attackDamage, float attackSpeed, Properties pProperties) {
            super(pTier, attackDamage, attackSpeed, pProperties);
        }
    }
}