...
public class Paxel extends MiningToolItem {
    ...
    public Paxel(ToolMaterial pTier, TagKey<Block> mineableTag, Settings pProperties) {
        super(pTier, mineableTag, pProperties);
    }
    ...
    private static final class Axe extends AxeItem {
        ...
        private Axe(ToolMaterial pTier, Settings pProperties) {
    ...
    private static final class Shovel extends ShovelItem {
        ...
        private Shovel(ToolMaterial pTier, Settings pProperties) {
            super(pTier, pProperties);
        }
    }
}