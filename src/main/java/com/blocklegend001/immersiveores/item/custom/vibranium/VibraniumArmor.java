...
public class VibraniumArmor extends ArmorItem {
    ...
    public VibraniumArmor(ArmorMaterial pMaterial, ArmorType pType, Properties pProperties) {
        super(pMaterial, pType, createSettings(pProperties, VibraniumConfig.unbreakableVibranium.get(), VibraniumConfig.durabilityVibranium.get()));
    }
