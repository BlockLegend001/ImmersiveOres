...
public class EnderiumBow extends BowItem {
    ...
    private final int ARROW_COUNT = EnderiumConfig.arrowCountEnderiumBow.get();
    ...
    public EnderiumBow(BowTier tier, Properties properties) {
        super(createSettings(properties, EnderiumConfig.unbreakableEnderium.get(), EnderiumConfig.durabilityEnderium.get()));
        this.tier = tier;
    }
