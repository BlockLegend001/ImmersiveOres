...
public class VulpusPickaxe extends PickaxeItem {
    ...
    public VulpusPickaxe(ToolMaterial p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
        super(p_42961_, p_42962_, p_42963_, createSettings(p_42964_, VulpusConfig.UNBREAKABLE_VULPUS.get(), VulpusConfig.DURABILITY_VULPUS.get()));
    }
