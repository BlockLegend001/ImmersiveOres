...
public class EnderiumExcavator extends Excavator implements Vanishable {

    public EnderiumExcavator(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
