...
public class VulpusAxe extends AxeItem {
    private static Properties createSettings(boolean unbreakable, int durability) {
        Properties settings = new Properties()
                ...
                .attributes(VulpusAxe.createAttributes(
                        ModToolTiers.VULPUS,
                        VulpusConfig.ATTACK_DAMAGE_VULPUS_AXE.get(),
                        (float) VulpusConfig.ATTACK_SPEED_VULPUS_AXE.get().doubleValue()
                ));
    ...
    public VulpusAxe(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
