...
public class VibraniumPickaxe extends PickaxeItem {
    ...
    public VibraniumPickaxe(ToolMaterial p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
        super(p_42961_, p_42962_, p_42963_, createSettings(p_42964_, VibraniumConfig.UNBREAKABLE_VIBRANIUM.get(), VibraniumConfig.DURABILITY_VIBRANIUM.get()));
    }
