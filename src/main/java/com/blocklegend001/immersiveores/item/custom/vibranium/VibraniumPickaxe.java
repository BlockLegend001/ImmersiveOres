...
public class VibraniumPickaxe extends PickaxeItem {
    private static Properties createSettings(boolean unbreakable, int durability) {
        Properties settings = new Properties()
                ...
                .attributes(VibraniumPickaxe.createAttributes(
                        ModToolTiers.VIBRANIUM,
                        VibraniumConfig.ATTACK_DAMAGE_VIBRANIUM_PICKAXE.get(),
                        (float) VibraniumConfig.ATTACK_SPEED_VIBRANIUM_PICKAXE.get().doubleValue()
                ));
    ...
    public VibraniumPickaxe(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
