...
public class VibraniumPaxel extends Paxel {
    private static Properties createSettings(boolean unbreakable, int durability) {
        Properties settings = new Properties()
                ...
                .attributes(VibraniumPaxel.createAttributes(
                        ModToolTiers.VIBRANIUM,
                        VibraniumConfig.ATTACK_DAMAGE_VIBRANIUM_PAXEL.get(),
                        (float) VibraniumConfig.ATTACK_SPEED_VIBRANIUM_PAXEL.get().doubleValue()
                ));
    ...
    public VibraniumPaxel(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
        super(p_42961_, ModTags.Blocks.VIBRANIUM_PAXEL_MINEABLE, p_42962_, p_42963_, createSettings(VibraniumConfig.UNBREAKABLE_VIBRANIUM.get(), VibraniumConfig.DURABILITY_VIBRANIUM.get()));
    }
