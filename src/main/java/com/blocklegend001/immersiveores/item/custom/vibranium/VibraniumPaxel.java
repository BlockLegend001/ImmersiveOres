...
public class VibraniumPaxel extends DiggerItem implements Vanishable {

    public VibraniumPaxel(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
        super(pAttackDamageModifier, pAttackSpeedModifier, pTier, ModTags.Blocks.VIBRANIUM_PAXEL_MINEABLE, pProperties);
    }
