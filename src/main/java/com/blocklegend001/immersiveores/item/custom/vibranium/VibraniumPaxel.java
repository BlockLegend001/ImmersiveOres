...
public class VibraniumPaxel extends Paxel {
    private static Properties createSettings(boolean unbreakable, int durability) {
        Properties settings = new Properties()
                ...
                .attributes(VibraniumPaxel.createAttributes(
                        ...
                        VibraniumConfig.attackDamageVibraniumPaxel.get(),
                        (float) VibraniumConfig.attackSpeedVibraniumPaxel.get().doubleValue()
                ));
    ...
    public VibraniumPaxel(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
        super(p_42961_, ModTags.Blocks.VIBRANIUM_PAXEL_MINEABLE, p_42962_, p_42963_, createSettings(VibraniumConfig.unbreakableVibranium.get(), VibraniumConfig.durabilityVibranium.get()));
    }
