...
public class EnderiumPaxel extends Paxel {
    ...
    public EnderiumPaxel(Tier tier, int attackDamage, float attackSpeed, Properties properties) {
        super(tier, ModTags.Blocks.ENDERIUM_PAXEL_MINEABLE, attackDamage, attackSpeed, createSettings());
    }
