...
public class EnderiumPaxel extends Paxel {
    ...
    public EnderiumPaxel(ToolMaterial pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
        super(pTier, ModTags.Blocks.ENDERIUM_PAXEL_MINEABLE, pAttackDamageModifier, pAttackSpeedModifier, createSettings(pProperties, EnderiumConfig.UNBREAKABLE_ENDERIUM.get(), EnderiumConfig.DURABILITY_ENDERIUM.get()));
    }
