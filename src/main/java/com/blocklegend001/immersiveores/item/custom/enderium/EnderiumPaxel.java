...
public class EnderiumPaxel extends Paxel {
    private static Properties createSettings(boolean unbreakable, int durability) {
        Properties settings = new Properties()
                ...
                .attributes(EnderiumPaxel.createAttributes(
                        ...
                        EnderiumConfig.attackDamageEnderiumPaxel.get(),
                        (float) EnderiumConfig.attackSpeedEnderiumPaxel.get().doubleValue()
                ));
    ...
    public EnderiumPaxel(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
        super(pTier, ModTags.Blocks.ENDERIUM_PAXEL_MINEABLE, pAttackDamageModifier, pAttackSpeedModifier, createSettings(EnderiumConfig.unbreakableEnderium.get(), EnderiumConfig.durabilityEnderium.get()));
    }
