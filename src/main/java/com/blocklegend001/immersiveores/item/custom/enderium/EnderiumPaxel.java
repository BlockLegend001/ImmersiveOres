...
public class EnderiumPaxel extends DiggerItem implements Vanishable{

    public EnderiumPaxel(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
        super(pAttackDamageModifier, pAttackSpeedModifier, pTier, ModTags.Blocks.ENDERIUM_PAXEL_MINEABLE, pProperties);
    }
