...
public class ModItems {
    ...
    public static final DeferredItem<Item> VIBRANIUM_SHOVEL = ITEMS.register("vibranium_shovel",
            () -> new VibraniumShovel(ModToolTiers.VIBRANIUM, VibraniumConfig.attackDamageVibraniumShovel, (float) VibraniumConfig.attackSpeedVibraniumShovel,
                    new Item.Properties().fireResistant().stacksTo(1).component(DataComponents.UNBREAKABLE, new Unbreakable(true)).component(DataComponents.UNBREAKABLE, new Unbreakable(true))
