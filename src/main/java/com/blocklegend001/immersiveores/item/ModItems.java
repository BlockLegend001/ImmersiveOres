...
public class ModItems {
    ...
    public static final Item VIBRANIUM_PICKAXE = registerItem("vibranium_pickaxe",
            new VibraniumPickaxe(ModToolMaterials.VIBRANIUM, VibraniumConfig.attackDamageVibraniumPickaxe, (float) VibraniumConfig.attackSpeedVibraniumPickaxe,
                    new Item.Settings().fireproof().component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE)
    ...
    public static final Item VIBRANIUM_BOW = registerItem("vibranium_bow",
            new VibraniumBow(BowTiers.VIBRANIUM, (new Item.Settings().fireproof().component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE)
    ...
    public static final Item VIBRANIUM_HELMET = registerItem("vibranium_helmet",
            new VibraniumArmor(ModArmorMaterials.VIBRANIUM, EquipmentType.HELMET,
                    new Item.Settings().fireproof().component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE).maxCount(1)
    ...
    public static final Item VIBRANIUM_HORSE_ARMOR = registerItem("vibranium_horse_armor",
            new Item(new Item.Settings().fireproof().horseArmor(ModArmorMaterials.VIBRANIUM).component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE).maxCount(1)
    ...
    public static final Item VULPUS_BOW = registerItem("vulpus_bow",
            new VulpusBow(BowTiers.VULPUS, (new Item.Settings().fireproof().component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE)
    ...
    public static final Item VULPUS_HORSE_ARMOR = registerItem("vulpus_horse_armor",
            new Item(new Item.Settings().fireproof().horseArmor(ModArmorMaterials.VULPUS).component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE).maxCount(1)
    ...
    public static final Item ENDERIUM_BOW = registerItem("enderium_bow",
            new EnderiumBow(BowTiers.ENDERIUM, (new Item.Settings().fireproof().component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE)
    ...
    public static final Item ENDERIUM_HORSE_ARMOR = registerItem("enderium_horse_armor",
            new Item(new Item.Settings().fireproof().horseArmor(ModArmorMaterials.ENDERIUM).component(DataComponentTypes.UNBREAKABLE, Unit.INSTANCE).maxCount(1)
