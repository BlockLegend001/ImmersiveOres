...
public class EnderiumConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue knockbackResistanceValueEnderiumArmor;
    ...
    public static final ForgeConfigSpec.IntValue protectionValueEnderiumHorseArmor;
    ...
    static {
        ...
        knockbackResistanceValueEnderiumArmor = BUILDER
                ...
                .defineInRange("knockbackResistanceValueEnderiumArmor", 0.4F, 0, Double.MAX_VALUE);
        ...
        protectionValueEnderiumHorseArmor = BUILDER
                .comment("Protection value for Horse Armor | Default Value = 20")
                .defineInRange("protectionValueEnderiumHorseArmor", 20, 0, Integer.MAX_VALUE);
        BUILDER.pop();
