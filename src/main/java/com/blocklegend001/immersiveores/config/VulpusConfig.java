...
public class VulpusConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue knockbackResistanceValueVulpusArmor;
    ...
    public static final ForgeConfigSpec.IntValue protectionValueVulpusHorseArmor;
    ...
    static {
        ...
        knockbackResistanceValueVulpusArmor = BUILDER
                ...
                .defineInRange("knockbackResistanceValueVulpusArmor", 0.3F, 0, Double.MAX_VALUE);
        ...
        protectionValueVulpusHorseArmor = BUILDER
                .comment("Protection value for Horse Armor | Default Value = 16")
                .defineInRange("protectionValueVulpusHorseArmor", 16, 0, Integer.MAX_VALUE);
        BUILDER.pop();
