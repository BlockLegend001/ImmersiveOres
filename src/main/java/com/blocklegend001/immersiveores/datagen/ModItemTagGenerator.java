...
public class ModItemTagGenerator extends FabricTagProvider.ItemTagProvider {
    ...
    public void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        valueLookupBuilder(ItemTags.SWORD_ENCHANTABLE).add(ModItems.VIBRANIUM_SWORD,
        ...
        valueLookupBuilder(ItemTags.VANISHING_ENCHANTABLE).add(ModItems.VIBRANIUM_HAMMER,
                ModItems.VULPUS_HAMMER,
                ModItems.ENDERIUM_HAMMER,
                ModItems.VIBRANIUM_EXCAVATOR,
                ModItems.VULPUS_EXCAVATOR,
        ...
        valueLookupBuilder(ModTags.Items.TOOLS_NETHERITE)
