...
public class ModItemTagGenerator extends FabricTagProvider.ItemTagProvider {
    ...
    public void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ConventionalItemTags.BOWS).add(ModItems.VIBRANIUM_BOW,
                ModItems.VULPUS_BOW,
        ...
        getOrCreateTagBuilder(ConventionalItemTags.RAW_ORES).add(ModItems.RAW_VIBRANIUM,
                ModItems.RAW_VULPUS,
