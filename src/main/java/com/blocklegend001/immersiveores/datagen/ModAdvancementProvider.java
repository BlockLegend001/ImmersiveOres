        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer) {
            AdvancementHolder rootAdvancement = Advancement.Builder.advancement()
                    .display(ModItems.VIBRANIUM_INGOT.get(),
                            ...
                            Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "textures/item/vulpus_block.png"),
                            AdvancementType.TASK, true, true, false)
                    .addCriterion("has_vibranium_ingot", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.VIBRANIUM_INGOT.get()))
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "root")));
            ...
            AdvancementHolder vibraniumTools = Advancement.Builder.advancement()
                    ...
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vibraniumtools")));
            ...
            AdvancementHolder vibraniumArmor = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vibraniumarmor")));
            ...
            AdvancementHolder vibraniumSpecialTools = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vibraniumspecialtools")));
            ...
            AdvancementHolder vulpus = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vulpus")));
            ...
            AdvancementHolder vulpusTools = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vulpustools")));
            ...
            AdvancementHolder vulpusArmor = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vulpusarmor")));
            ...
            AdvancementHolder vulpusSpecialTools = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "vulpusspecialtools")));
            ...
            AdvancementHolder enderium = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "enderium")));
            ...
            AdvancementHolder enderiumTools = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "enderiumtools")));
            ...
            AdvancementHolder enderiumArmor = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "enderiumarmor")));
            ...
            AdvancementHolder enderiumSpecialTools = Advancement.Builder.advancement()
                    ...
                    .requirements(AdvancementRequirements.Strategy.AND)
                    .save(consumer, String.valueOf(Identifier.fromNamespaceAndPath(ImmersiveOres.MODID, "enderiumspecialtools")));
        }
    }
}
