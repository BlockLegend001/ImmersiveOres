...
public class ModBlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        this.tag(ModTags.Blocks.BEACON_BASE_BLOCKS)
                .add(ModBlocks.VIBRANIUM_BLOCK.getKey(),
                        ModBlocks.VULPUS_BLOCK.getKey(),
                        ModBlocks.ENDERIUM_BLOCK.getKey());

        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(ModBlocks.VIBRANIUM_BLOCK.getKey(),
                        ModBlocks.VULPUS_BLOCK.getKey(),
                        ModBlocks.ENDERIUM_BLOCK.getKey(),
                        ModBlocks.VIBRANIUM_ORE.getKey(),
                        ModBlocks.VULPUS_ORE.getKey(),
                        ModBlocks.ENDERIUM_ORE.getKey(),
                        ModBlocks.RAW_VIBRANIUM_BLOCK.getKey(),
                        ModBlocks.RAW_VULPUS_BLOCK.getKey(),
                        ModBlocks.RAW_ENDERIUM_BLOCK.getKey());
        ...
        this.tag(ModTags.Blocks.NEEDS_VIBRANIUM_TOOL)
                .add(ModBlocks.VULPUS_BLOCK.getKey(),
                        ModBlocks.VULPUS_ORE.getKey(),
                        ModBlocks.RAW_VULPUS_BLOCK.getKey());

        this.tag(ModTags.Blocks.NEEDS_VULPUS_TOOL)
                .add(ModBlocks.ENDERIUM_BLOCK.getKey(),
                        ModBlocks.ENDERIUM_ORE.getKey(),
                        ModBlocks.RAW_ENDERIUM_BLOCK.getKey());
        ...
        this.tag(Tags.Blocks.ORES)
                .add(ModBlocks.VIBRANIUM_ORE.getKey(),
                        ModBlocks.VULPUS_ORE.getKey(),
                        ModBlocks.ENDERIUM_ORE.getKey());
